      ...
      <aside className="admin-sidebar">
        ...
        <nav>
          <ul>
            ...
            <li><NavLink to="/admin/pagos-ordenes"><i className="fas fa-money-check-alt me-2"></i>Pagos / Órdenes</NavLink></li>
            <li><NavLink to="/admin/todas-ordenes"><i className="fas fa-list-alt me-2"></i>Todas las Órdenes</NavLink></li>
